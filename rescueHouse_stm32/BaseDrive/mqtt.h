...
#define  PRODUCTKEY           "a1yDhJ1PZZa"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "rescue1"                                       //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "3e8aceeefa68d9462a8fbbb193f72561"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "subscribe_topic"  //需要订阅的主题  
#define  P_TOPIC_NAME         "publish_topic"   //需要发布的主题     
